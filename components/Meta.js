...
const Meta = ({ title, keywords, description }) => {
  return (
		...
		{/*Primary Meta Tags*/}
		 ...
		 <meta itemProp="description" content="Pixacod is a digital agency specializing in Branding, Digital Marketing, UX/UI Design, Custom Development, & eCommerce."></meta>
		...
		<meta property="og:description" content="Pixacod is a digital agency specializing in Branding, Digital Marketing, UX/UI Design, Custom Development, & eCommerce."></meta>
		...
		<meta name="twitter:description" content="Pixacod is a digital agency specializing in Branding, Digital Marketing, UX/UI Design, Custom Development, & eCommerce."></meta>
...
Meta.defaultProps = {
  title: 'Digital creative agency | Pixacod',
  keywords: 'User Experience Design, UX Design, UX Design Agency, Product Design UX, Mobile UX, App UX',
  description: 'Pixacod is a digital agency specializing in Branding, Digital Marketing, UX/UI Design, Custom Development, & eCommerce.',
}
